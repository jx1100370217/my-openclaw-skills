...
| 技能 | 描述 |
|------|------|
| [paper-to-html](./paper-to-html/) | 把学术论文 PDF 精读成精美中文 HTML：MathJax 渲染公式 + 从 PDF 提取原文配图，并叠加"直觉/机制/批判/对读者启发"的理解。内置现成 HTML 设计系统（侧栏目录、明暗主题、七种 callout、公式块与数据表组件）与配图提取手册。 |
